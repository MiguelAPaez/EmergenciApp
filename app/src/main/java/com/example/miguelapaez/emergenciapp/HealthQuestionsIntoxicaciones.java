...
public class HealthQuestionsIntoxicaciones extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_health_questions_intoxicaciones);
        ...
        for (int i = 0; i < mainGrid.getChildCount(); i++) {
            ...
            cardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(finalI == 0){
                        Intent intent = new Intent ( HealthQuestionsIntoxicaciones.this, MedicalCenters.class);
